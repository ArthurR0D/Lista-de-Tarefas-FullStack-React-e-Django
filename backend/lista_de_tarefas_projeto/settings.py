...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '*']  # Adicionar * para desenvolvimento
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='lista_de_tarefas_db'),
        'USER': config('DB_USER', default='postgres'),
        'PASSWORD': config('DB_PASSWORD', default='JulietaeLana1'),
